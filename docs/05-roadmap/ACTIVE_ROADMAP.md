...
Action: Publish the exact-nine RC-STG-006O23B V5 opaque-cursor read-only continuation as one literal non-merge child of retired V4 authority f17b2278542ef6836550a556abd97d82c9bf79db, instantiate and audit the separate immutable V5 binding, then execute only the zero-mutation provider/npm/activation/probe/final/postflight/cleanup sequence defined below
