...
Action: Publish the exact-nine RC-STG-006O23A V4 read-only continuation as one literal non-merge child of consumed V3 authority 43e99e686214a2f36f52ee7c426db2015d709bee, instantiate and audit the separate immutable V4 binding, then execute only the zero-mutation provider/npm/activation/probe/final/postflight/cleanup sequence defined below
