...
Action: Publish the exact-nine RC-STG-006O23C V6 scalar-transport read-only continuation as one literal non-merge child of retired V5 authority dceb3c79d4df647e1929ffe807ad5f0ed6bb2d10, instantiate and audit the separate immutable V6 binding, then execute only the zero-provider-mutation PRE/held-PRE/arm/sealed-npm/POST/activation/held-POST/FINAL/postflight/cleanup sequence defined below
