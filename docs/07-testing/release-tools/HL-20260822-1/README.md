# HL-20260822-1 strict manager-transfer browser helper
...
* an exclusive action horizon ending at `2026-08-24T07:00:00.000Z`.
...
`.netlify/strict-release-HL-20260822-1/original-dist`. Its verifier inventory
...
```text
scripts/npm-approved.cmd exec -- vite build --config docs/07-testing/release-tools/HL-20260822-1/vite.config.mjs
```

Create the additive deploy candidate at
`.netlify/strict-release-HL-20260822-1/helper-overlay-dist` by copying the
sealed 33-file directory, then add only these four runtime files:

```text
release-qa/hl-20260822-1/strict-manager-transfer.html
release-qa/hl-20260822-1/strict-manager-transfer.js
release-qa/hl-20260822-1/strict-manager-transfer.css
release-qa/hl-20260822-1/enabled.json
```
...
```text
.tools/node-v24.14.1-win-x64/node.exe docs/07-testing/release-tools/HL-20260822-1/verify-strict-manager-transfer.mjs
.tools/node-v24.14.1-win-x64/node.exe docs/07-testing/release-tools/HL-20260822-1/verify-strict-manager-transfer.mjs --overlay-root .netlify/strict-release-HL-20260822-1/helper-overlay-dist
scripts/npm-approved.cmd exec -- vitest run docs/07-testing/release-tools/HL-20260822-1/strict-manager-transfer.test.mjs
```
...
```text
.tools/node-v24.14.1-win-x64/node.exe docs/07-testing/release-tools/HL-20260822-1/verify-strict-manager-transfer.mjs --retired-baseline-root .netlify/strict-release-HL-20260822-1/original-dist
```
