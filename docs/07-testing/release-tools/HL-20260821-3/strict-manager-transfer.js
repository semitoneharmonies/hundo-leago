...
(function() {
  ...
  (() => {
    ...
    const EXPECTED_PATH = "/release-qa/hl-20260821-3/strict-manager-transfer";
    const API_ORIGIN = "https://api-staging.hundoleago.com";
    const ACTIVATION_URL = "https://staging.hundoleago.com/release-qa/hl-20260821-3/enabled.json";
