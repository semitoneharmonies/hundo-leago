...
1. Open your league home. Check team logos, the league season, matchup cards and the detailed Trade block.
2. Open Teams, then your team's roster. Check NHL teams, player actions, Active lines and the compact Bench cards.
3. Open Players. Try a name search, team/position filters, Favorites and the next page of results.
4. Open Drafts and Auctions. Check the selected team's draft results, full Free Agent Draft labels, and total contract value when changing salary and term. Other managers' private offers must stay private.
5. Open Trades. Check the Player selector and salary retention beside the selected player. Future considerations should explain the commissioner approval step.
6. Open Matchups, Standings and League activity. Check that teams, weeks and events are understandable.
7. Open Notifications. Check unread items and Previous notifications. Then open League Rules from the main menu and Account and team settings from your account menu.
8. Refresh a nested page, then sign out and back in. Repeat the main navigation on your phone or a narrow window.

A manager should see only their permitted league and team actions. If you use the Beta manager, Alpha must not become available.

## Then check commissioner and administrator tools

As the Alpha commissioner, check:
