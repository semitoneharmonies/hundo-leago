...
### M7-26 Fresh Strict Release - 2026-08-23 (V3 ACTION SUCCEEDED; V4 RETIRED UNCONSUMED; O23/O23A ACCEPTANCE PENDING O23B; V5 OPAQUE-CURSOR READ-ONLY CONTINUATION AUTHORIZED NEXT; P23 AND LATER GATES NOT AUTHORIZED)
...
diagnostic-only opaque-cursor read, remained unconsumed, and was retired. O23
and O23A acceptance now await the separately authorized V5/O23B continuation
below. Chrome disk/FD reproof remains pending.
