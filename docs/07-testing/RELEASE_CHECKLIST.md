...
## 2026-08-23 M7-26 Fresh Strict Release (V3 ACTION SUCCEEDED; V4 RETIRED UNCONSUMED; O23/O23A ACCEPTANCE PENDING O23B; V5 OPAQUE-CURSOR READ-ONLY CONTINUATION AUTHORIZED NEXT)
...
external probes pass; O23 and O23A source/target acceptance remains pending
O23B.
...
- [ ] `RC-STG-006O23B` remains unchecked and is not currently eligible. Only
  after the exact V5 direct-child publication and separate binding audit may
  its frozen zero-mutation sequence run. It may be checked only together with
  `RC-STG-006O23` and `RC-STG-006O23A` after V5 aggregate postflight and zero-
  delete cleanup both pass; this is prospective acceptance, not evidence that
  any of the three gates has completed.
...
unconsumed, and was retired. O23 and O23A acceptance now await the separately
authorized V5/O23B continuation; O23B is unchecked. P23, backup,
...
`RC-STG-006O23B`, and `RC-STG-006P23` remain unchecked. O23 and O23A acceptance
now awaits the separately authorized zero-mutation V5/O23B continuation after
its exact-nine direct-child publication and separate binding. P23 semantic
...
artifact, or capture sentinel, and V4 is retired. O23 and O23A remain unchecked
pending O23B; the literal non-merge exact-nine V5/O23B continuation is
authorized next only after direct-child publication from f17b and a separate
V5 binding audit. Normal restore and phase two remain forbidden;
