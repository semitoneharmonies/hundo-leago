...
V4 is retired, O23 and O23A remain unchecked pending O23B, and only the
zero-mutation V5/O23B continuation is authorized next after its exact-nine
direct-child publication and separate binding.
...
artifact, or capture sentinel, so V4 is retired. O23 and O23A remain unchecked
pending O23B, and only the literal non-merge exact-nine V5 direct child of f17b
plus separate V5 binding may authorize the zero-mutation continuation.
...
O23 and O23A acceptance remain pending O23B; only V5/O23B is authorized next.
