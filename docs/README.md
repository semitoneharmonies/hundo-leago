...
authority. O23, O23A, O23B, O23C, and O23D remain
`UNCHECKED_PENDING_O23E`; O23E remains `UNCHECKED`. Only V8/O23E is authorized
...
exact-nine V8/O23E authority child of d0d80e98 may proceed through one
...
no phase reservation, and retired with no retry or binding. O23 through O23D
remain `UNCHECKED_PENDING_O23E`; O23E is `UNCHECKED`. Only V8/O23E is authorized
next through exact-nine publication, one sessionless prebinding diagnostic,
exact observation binding, and the frozen three-phase sequence.
